...
hist(average_and_stddev_values$"96"_avg)
...
#Move the meta (geneID) information to the columns and then replace with geneID column
...
#pivot longer will lead to more plots from facet wrap 
...
# merging bigger list into the smaller list 
...
#gsub substitutes with whatever is in the middle column
# NOW THE PLOT !
...
# + and - will make the error bars symmetric 
...
#You are able to group by gene_id and Time and this allows you to make new columns of mean_TPM and sd_TPM because the group columns are in the program's memory
