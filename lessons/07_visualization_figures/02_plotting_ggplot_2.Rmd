...
# Density maps, circles getting smaller and smaller indicates the peak of the data 
...
# $ sign indexes into the two variables
#lm will allow us to see if there is a linear relationship between variables
